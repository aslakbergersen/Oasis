...
if __name__ == "__main__":
    ...
    u_90, p_90, points, t = plot_probes(b_90, no_plot=True)
    u_91, p_91, points, t = plot_probes(b_91, no_plot=True)
    u_92, p_92, points, t = plot_probes(b_92, no_plot=True)
    u_93, p_93, points, t = plot_probes(b_93, no_plot=True)
    u_94, p_94, points, t = plot_probes(b_94, no_plot=True)
