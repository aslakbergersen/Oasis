...
python NSfracStep.py problem=MMS N=20 dt=0.001 T=0.003 solver=IPCS
python NSfracStep.py problem=MMS N=50 dt=0.001 T=0.003 solver=IPCS
python NSfracStep.py problem=MMS N=100 dt=0.001 T=0.003 solver=IPCS
